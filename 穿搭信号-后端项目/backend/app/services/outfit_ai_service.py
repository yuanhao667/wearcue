...
SCENE_CONTEXT: Dict[str, Dict[str, str]] = {
    "commute": {
        "scene_name": "通勤",
        "scene_requirements": "优先得体利落、轮廓简洁、易打理，方便工作或上学及日常走动；方案名突出利落、简约或得体，不能只写天气感。",
    },
    "date": {
        "scene_name": "约会",
    ...
    "travel": {
        "scene_name": "出行",
        "scene_requirements": "优先舒适、方便活动、耐走、易打理，适合较长时间在外，避免正式束缚；方案名突出舒适、轻旅、活力、机能、便携或松弛中的真实特点，禁止使用“清爽出行”这类天气词加场景的机械命名。",
    },
}
