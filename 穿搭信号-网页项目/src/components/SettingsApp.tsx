...
export function SettingsApp() {
  ...
  return <main className="paper-page settings-paper">
    ...
    {status === "success" && settings && <div className="settings-paper-grid">
      ...
      <section className="settings-paper-card settings-account-card"><div className="card-caption">账号管理</div><h2>退出当前账号</h2><p>退出后需要重新登录才能查看个人穿搭与设置。</p><button className="settings-logout-button" onClick={() => void logout()}>退出登录</button></section>
    </div>}
